...
type RefreshToken = (body: { token: string }) => Promise<AxiosResponse<{ data: IUser }>>
...
export const refreshToken: RefreshToken = (body) =>
  axiosClient.post(API_ENPOINT.AUTHORIZATION.REFRESH_TOKEN, body)
