...
type DeleteBlog = (id: string) => Promise<AxiosResponse<any>>
...
export const updateBlog: UpdateBlog = (id, body) =>
  axiosClient.put(`${API_ENPOINT.BLOGS}/${id}`, body, configFormData)
export const deleteBlog: DeleteBlog = (id) => axiosClient.delete(`${API_ENPOINT.BLOGS}/${id}`)
