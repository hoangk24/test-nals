...
import { getProfileAction, loginAction, registerAction, updateProfileAction } from 'features/auth/auth.action'
...
export default function useAuth() {
  ...
  const updateProfile=(data:any)=>{
    dispatch(updateProfileAction(data)).then(unwrapResult).then((res:any)=>{
